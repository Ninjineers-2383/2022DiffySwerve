...
DiffSwerveModule::DiffSwerveModule(int topMotorChannel, int bottomMotorChannel, int encoderPort, std::string name, std::string CANbus, wpi::log::DataLog & log): m_topMotor(topMotorChannel, CANbus),
  m_bottomMotor(bottomMotorChannel, CANbus),
  m_topMotorSim {
    m_topMotor.GetSimCollection()
  },
  m_bottomMotorSim {
    m_bottomMotor.GetSimCollection()
  },
  m_topMotorSimulator {
    frc::DCMotor::Falcon500(), 1, units::kilogram_square_meter_t {
      0.0005
    }
  },
  m_bottomMotorSimulator {
    frc::DCMotor::Falcon500(), 1, units::kilogram_square_meter_t {
      0.0005
    }
  },
